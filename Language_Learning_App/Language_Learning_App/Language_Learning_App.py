...
import tkinter.font as tkFont #add fonts, I guess?
import starter
import lrnWindow
import redactText
...
#to do
# 1.fix arrows while redacting
# 2.fix how long words appear in lrnWindow



mainWindow = tk.Tk()
mainWindow.title("MiuIueie")
mainWindow.geometry("1711x701")
...
labels = [[tk.Label(mainWindow, text = f"{i}", bg = labelsBackgroundColour, fg="#5ab2a9", font=("Arial", 17), anchor = "w") for i in range(3)] for _ in range(11)] #creating list of 11 lists, each of them contains 4 Labels. It's like a good thing to write _ but x will do too. Anchor makes the text aligned to the left side.
...
wholeStringHighlight = tk.Frame(mainWindow, bg = "#FFBDBD", width = 1710, height = 41) #creating a background for selected string
wholeStringHighlight.place(x = 0, y = tw.currentStringHighlightHeight)
